...
#kubectl annotate service activity-app skupper.io/proxy=http -n benelux
...
#kubectl annotate service activity-app skupper.io/proxy=http -n cee
#skupper init
#skupper link create token.yaml

#kubectl config set-context $(kubectl config current-context) --namespace=uki
#kubectl apply -f backend-uki.yml -n uki
#kubectl annotate service activity-app skupper.io/proxy=http -n uki
#skupper init
#skupper link create token.yaml
